...
# Security and Privacy Concerns with uploading the project. 
# Option to upload an image or just do a realtime attendance.
# Acknowledgements or consent form (measure).
