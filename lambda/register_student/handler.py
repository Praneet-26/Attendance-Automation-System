...
# subject = "Student Registered successfully for SWEN Capstone."
...
#     <p> {student_name} has been successsfully registered for class SWEN Capstone. Have Fun!</a>.</p>
...
# #     <body>
# #     <h1>Hey Hi...</h1>
# #     <p>Dear Student of class SWEN Capstone. Your image is successfully registered into the attendance system. Have Fun!</a>.</p>
# #     </body>
# #     </html>
# #                 """
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if response['ResponseMetadata']['HTTPStatusCode'] == 200:
            ...
            <body>
                <h2>Dear Professor,</h2>
                <p>{firstName} {lastName} has been successfully registered for class SWEN Capstone.</p>
                <h3>Student Details:</h3>
